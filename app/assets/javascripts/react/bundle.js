...
module.exports = React.createClass({
  ...
  render: function () {
    return React.createElement('div', { className: 'close-modal', onClick: this.handleClick });
  }
});

},{"react":167,"react-dom":38}],2:[function(require,module,exports){
var React = require('react');
var ReactDOM = require('react-dom');
...
module.exports = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement(
      'div',
      { className: 'color-picker', style: { display: this.props.display } },
      colors
    );
  }
});
...
},{"react":167,"react-dom":38}],3:[function(require,module,exports){
var React = require('react');
var ReactDOM = require('react-dom');
...
},{"react":167,"react-dom":38}],4:[function(require,module,exports){
var React = require('react');
var ReactDOM = require('react-dom');
    ...
    var commentNodes = this.props.data.map((function (comment) {
      if (comment.isStub) {
        return React.createElement(
          ...
          React.createElement('div', { className: 'avatar stub' }),
...
var Comment = React.createClass({
  ...
  handleBodyClick: function (e) {
    ...
    var newBody = replaceNthMatch(this.state.body, /(\[(?:x|\s)\])/, index + 1, checkbox_value);
  ...
  render: function () {
    return React.createElement(
      'div',
      { className: this.state.currentClass, style: { backgroundColor: this.state.backgroundColor } },
      React.createElement(Avatar, { data: this.props.data.user, width: 40, height: 40 }),
      React.createElement(
        'div',
        { className: 'header' },
        React.createElement(Login, { data: this.props.data.user.login }),
...
var CommentEditForm = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement(
      ...
      React.createElement(UploadForm, { display: this.props.display, onUpload: this.handleUpload })
    );
  }
});

},{"./upload-form.jsx":10,"react":167,"react-dom":38}],5:[function(require,module,exports){
var React = require('react');
var ReactDOM = require('react-dom');
...
},{"react":167,"react-dom":38}],6:[function(require,module,exports){
$(document).on('turbolinks:load', function () {
  ...
  window.IssueModal = React.createClass({
    ...
    issueUrl: function () {
      return '/boards/' + this.props.githubFullName + '/issues/' + this.props.issue.number;
    },
    ...
    render: function () {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(CurrentLabelList, { data: this.state.currentLabels }),
          React.createElement(
            'div',
            { className: 'move-to' },
          ...
          React.createElement('div', { className: 'issue-body', dangerouslySetInnerHTML: this.bodyMarkdown() }),
        ...
        React.createElement(
          ...
          React.createElement(LabelList, { data: this.props.issue.labels, onLabelChange: this.handleLabelChange }),
  ...
  var CurrentAssignee = React.createClass({
    displayName: 'CurrentAssignee',

    render: function () {
      if (this.props.user) {
        return React.createElement('img', { className: 'current-assignee', src: this.props.user.avatarUrl, title: this.props.user.login });
      } else {
        return React.createElement('div', { className: 'current-assignee' });
      }
    }
  });

  var CurrentLabelList = React.createClass({
    displayName: 'CurrentLabelList',
  ...
  var DueDateAction = React.createClass({
    ...
    render: function () {
      return React.createElement(
        'div',
        null,
        React.createElement(EditButton, { name: 'Due Date', onButtonClick: this.handleEditButtonClick, icon: 'octicon octicon-clock' }),
        React.createElement(PopoverOverlay, { display: this.state.overlay, onOverlayClick: this.handleEditButtonClick }),
        React.createElement(
          'div',
          { className: 'due-date-calendar hidden' },
          React.createElement('div', { className: 'datepicker', ref: 'datepicker' }),
  ...
  var AssigneeList = React.createClass({
    ...
    render: function () {
      ...
      return React.createElement(
        'div',
        null,
        React.createElement(EditButton, { name: 'Assignee', onButtonClick: this.handleEditButtonClick, icon: 'octicon octicon-person' }),
        React.createElement(PopoverOverlay, { display: this.state.overlay, onOverlayClick: this.handleEditButtonClick }),
        React.createElement(
          'div',
  ...
  var Assignee = React.createClass({
    ...
    handleChange: function () {
      this.props.onAssigneeChange(this.props.user, !this.props.assigned);
    },
    render: function () {
      ...
      return React.createElement(
        ...
        React.createElement('span', { className: checkedClass })
      );
    }
  });
  ...
  var LabelList = React.createClass({
    ...
    render: function () {
      var labelNodes = this.props.data.map((function (label) {
        return React.createElement(
          Label,
          { key: label.id, data: label, onLabelChange: this.props.onLabelChange },
          label.name
        );
      }).bind(this));
      return React.createElement(
  ...
  var EditButton = React.createClass({
    ...
    render: function () {
      return React.createElement(
        'div',
        { className: this.buttonClass(), onClick: this.handleClick, title: this.props.title },
  ...
  var ToggleButton = React.createClass({
    ...
    buttonClass: function () {
      ...
      return this.props.name.replace(/\s/g, '-').toLowerCase() + ' issue-button ' + activeClass;
    },
    render: function () {
      return React.createElement(
        'div',
  ...
  window.IssueModalRender = function (issue, githubFullName, isReadonly) {
    ReactDOM.render(React.createElement(IssueModal, {
      issue: issue,
...
},{"./close-button.jsx":1,"./color-picker.jsx":2,"./column-list.jsx":3,"./comment-list.jsx":4,"./label.jsx":5,"./modal-new.jsx":7,"./popover.jsx":8,"./title.jsx":9,"./upload-form.jsx":10,"react":167,"react-dom":38}],7:[function(require,module,exports){
var React = require('react');
var ReactDOM = require('react-dom');
var CloseButton = require('./close-button.jsx');
var Label = require('./label.jsx');
...
module.exports = React.createClass({
  ...
  render: function () {
    var labelNodes = this.props.labels.map((function (label) {
      return React.createElement(
        Label,
        { key: label.id, data: label, onLabelChange: this.handleLabelChange },
        label.name
      );
    }).bind(this));
    return React.createElement(
      ...
      React.createElement(
        'div',
        { className: 'options-block', style: { display: this.state.displayOption } },
        React.createElement(ColorPicker, {
          display: 'block',
          onColorChange: this.handleColorOnChange
        })
...
},{"./close-button.jsx":1,"./color-picker.jsx":2,"./label.jsx":5,"react":167,"react-dom":38}],8:[function(require,module,exports){
var React = require('react');
var ReactDOM = require('react-dom');
...
},{"react":167,"react-dom":38}],9:[function(require,module,exports){
var React = require('react');
var ReactDOM = require('react-dom');
...
module.exports = React.createClass({
  ...
  componentWillUpdate: function (newProps, newState) {
    if (newState.textarea == 'block') {
      ...
      if (isNeedElastic) {
        $textarea.css('height', $textarea.parent().find('h1').height().toString() + 'px');
        setTimeout((function () {
          $textarea.addClass('elasticable');
          $textarea.elastic();
        }).bind(this), 10);
...
},{"./popover.jsx":8,"react":167,"react-dom":38}],10:[function(require,module,exports){
var React = require('react');
var ReactDOM = require('react-dom');
...
module.exports = React.createClass({
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement('input', { ref: 'uploadFile', type: 'file', name: '/[img]', id: '_img' })
    );
  }
});

},{"react":167,"react-dom":38}],11:[function(require,module,exports){
(function (process){
/**
...
},{"./emptyFunction":18,"_process":168}],12:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ExecutionEnvironment":12,"./createArrayFromMixed":16,"./getMarkupWrap":22,"./invariant":26,"_process":168}],18:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ExecutionEnvironment":12,"./invariant":26,"_process":168}],23:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"_process":168}],27:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./invariant":26,"_process":168}],30:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./invariant":26,"_process":168}],37:[function(require,module,exports){
(function (process){
/**
...
},{"./emptyFunction":18,"_process":168}],38:[function(require,module,exports){
'use strict';
...
},{"./ReactMount":103,"./findDOMNode":146,"fbjs/lib/focusNode":20}],40:[function(require,module,exports){
/**
 * Copyright 2013-2015 Facebook, Inc.
 * All rights reserved.
 *
...
},{"./EventConstants":52,"./EventPropagators":56,"./FallbackCompositionState":57,"./SyntheticCompositionEvent":128,"./SyntheticInputEvent":132,"fbjs/lib/ExecutionEnvironment":12,"fbjs/lib/keyOf":30}],41:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./CSSProperty":41,"./ReactPerf":109,"./dangerousStyleValue":143,"_process":168,"fbjs/lib/ExecutionEnvironment":12,"fbjs/lib/camelizeStyleName":14,"fbjs/lib/hyphenateStyleName":25,"fbjs/lib/memoizeStringOnly":32,"fbjs/lib/warning":37}],43:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./Object.assign":60,"./PooledClass":61,"_process":168,"fbjs/lib/invariant":26}],44:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./EventConstants":52,"./EventPluginHub":53,"./EventPropagators":56,"./ReactUpdates":121,"./SyntheticEvent":130,"./getEventTarget":152,"./isEventSupported":157,"./isTextInputElement":158,"fbjs/lib/ExecutionEnvironment":12,"fbjs/lib/keyOf":30}],45:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Danger":49,"./ReactMultiChildUpdateTypes":105,"./ReactPerf":109,"./setInnerHTML":162,"./setTextContent":163,"_process":168,"fbjs/lib/invariant":26}],47:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"_process":168,"fbjs/lib/invariant":26}],48:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./DOMProperty":47,"./ReactPerf":109,"./quoteAttributeValueForBrowser":160,"_process":168,"fbjs/lib/warning":37}],49:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"_process":168,"fbjs/lib/ExecutionEnvironment":12,"fbjs/lib/createNodesFromMarkup":17,"fbjs/lib/emptyFunction":18,"fbjs/lib/getMarkupWrap":22,"fbjs/lib/invariant":26}],50:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./EventConstants":52,"./EventPropagators":56,"./ReactMount":103,"./SyntheticMouseEvent":134,"fbjs/lib/keyOf":30}],52:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"fbjs/lib/keyMirror":29}],53:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./EventPluginRegistry":54,"./EventPluginUtils":55,"./ReactErrorUtils":94,"./accumulateInto":140,"./forEachAccumulated":148,"_process":168,"fbjs/lib/invariant":26,"fbjs/lib/warning":37}],54:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"_process":168,"fbjs/lib/invariant":26}],55:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./EventConstants":52,"./ReactErrorUtils":94,"_process":168,"fbjs/lib/invariant":26,"fbjs/lib/warning":37}],56:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./EventConstants":52,"./EventPluginHub":53,"./accumulateInto":140,"./forEachAccumulated":148,"_process":168,"fbjs/lib/warning":37}],57:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./DOMProperty":47,"fbjs/lib/ExecutionEnvironment":12}],59:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactPropTypeLocations":111,"./ReactPropTypes":112,"_process":168,"fbjs/lib/invariant":26,"fbjs/lib/warning":37}],60:[function(require,module,exports){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"_process":168,"fbjs/lib/invariant":26}],62:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactInstanceMap":100,"./findDOMNode":146,"_process":168,"fbjs/lib/warning":37}],64:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactReconciler":114,"./instantiateReactComponent":156,"./shouldUpdateReactComponent":164,"./traverseAllChildren":165,"_process":168,"fbjs/lib/warning":37}],66:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./PooledClass":61,"./ReactElement":90,"./traverseAllChildren":165,"fbjs/lib/emptyFunction":18}],67:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./Object.assign":60,"./ReactComponent":68,"./ReactElement":90,"./ReactNoopUpdateQueue":107,"./ReactPropTypeLocationNames":110,"./ReactPropTypeLocations":111,"_process":168,"fbjs/lib/emptyObject":19,"fbjs/lib/invariant":26,"fbjs/lib/keyMirror":29,"fbjs/lib/keyOf":30,"fbjs/lib/warning":37}],68:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactNoopUpdateQueue":107,"./canDefineProperty":142,"_process":168,"fbjs/lib/emptyObject":19,"fbjs/lib/invariant":26,"fbjs/lib/warning":37}],69:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"_process":168,"fbjs/lib/invariant":26}],71:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactElement":90,"./ReactElementValidator":91,"_process":168,"fbjs/lib/mapObject":31}],77:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./DOMChildrenOperations":46,"./DOMPropertyOperations":48,"./ReactMount":103,"./ReactPerf":109,"_process":168,"fbjs/lib/invariant":26}],79:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./LinkedValueUtils":59,"./Object.assign":60,"./ReactDOMIDOperations":78,"./ReactMount":103,"./ReactUpdates":121,"_process":168,"fbjs/lib/invariant":26}],80:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./Object.assign":60,"./ReactChildren":66,"./ReactDOMSelect":81,"_process":168,"fbjs/lib/warning":37}],81:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./LinkedValueUtils":59,"./Object.assign":60,"./ReactMount":103,"./ReactUpdates":121,"_process":168,"fbjs/lib/warning":37}],82:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./getNodeForCharacterOffset":154,"./getTextContentAccessor":155,"fbjs/lib/ExecutionEnvironment":12}],83:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./LinkedValueUtils":59,"./Object.assign":60,"./ReactDOMIDOperations":78,"./ReactUpdates":121,"_process":168,"fbjs/lib/invariant":26,"fbjs/lib/warning":37}],86:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":60,"./ReactUpdates":121,"./Transaction":138,"fbjs/lib/emptyFunction":18}],87:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./DOMProperty":47,"./ReactDefaultPerfAnalysis":89,"./ReactMount":103,"./ReactPerf":109,"fbjs/lib/performanceNow":34}],89:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactCurrentOwner":72,"./ReactElement":90,"./ReactPropTypeLocationNames":110,"./ReactPropTypeLocations":111,"./canDefineProperty":142,"./getIteratorFn":153,"_process":168,"fbjs/lib/invariant":26,"fbjs/lib/warning":37}],92:[function(require,module,exports){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":60,"./PooledClass":61,"./ReactInstanceHandles":99,"./ReactMount":103,"./ReactUpdates":121,"./getEventTarget":152,"fbjs/lib/EventListener":11,"fbjs/lib/ExecutionEnvironment":12,"fbjs/lib/getUnboundedScrollPosition":23}],97:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactDOMSelection":82,"fbjs/lib/containsNode":15,"fbjs/lib/focusNode":20,"fbjs/lib/getActiveElement":21}],99:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactRootIndex":116,"_process":168,"fbjs/lib/invariant":26}],100:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":60,"_process":168,"fbjs/lib/invariant":26}],107:[function(require,module,exports){
(function (process){
/**
...
},{"_process":168,"fbjs/lib/warning":37}],108:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"_process":168,"fbjs/lib/invariant":26}],109:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactElement":90,"./ReactPropTypeLocationNames":110,"./getIteratorFn":153,"fbjs/lib/emptyFunction":18}],113:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./CallbackQueue":43,"./Object.assign":60,"./PooledClass":61,"./Transaction":138,"fbjs/lib/emptyFunction":18}],120:[function(require,module,exports){
(function (process){
/**
 * Copyright 2015, Facebook, Inc.
 * All rights reserved.
...
},{"./Object.assign":60,"./ReactCurrentOwner":72,"./ReactElement":90,"./ReactInstanceMap":100,"./ReactUpdates":121,"_process":168,"fbjs/lib/invariant":26,"fbjs/lib/warning":37}],121:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./CallbackQueue":43,"./Object.assign":60,"./PooledClass":61,"./ReactPerf":109,"./ReactReconciler":114,"./Transaction":138,"_process":168,"fbjs/lib/invariant":26}],122:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./EventConstants":52,"./EventPropagators":56,"./ReactInputSelection":98,"./SyntheticEvent":130,"./isTextInputElement":158,"fbjs/lib/ExecutionEnvironment":12,"fbjs/lib/getActiveElement":21,"fbjs/lib/keyOf":30,"fbjs/lib/shallowEqual":35}],125:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":60,"./PooledClass":61,"_process":168,"fbjs/lib/emptyFunction":18,"fbjs/lib/warning":37}],131:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"_process":168,"fbjs/lib/invariant":26}],139:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"_process":168,"fbjs/lib/invariant":26}],141:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":60,"_process":168,"fbjs/lib/warning":37}],145:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactCurrentOwner":72,"./ReactInstanceMap":100,"./ReactMount":103,"_process":168,"fbjs/lib/invariant":26,"fbjs/lib/warning":37}],147:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./traverseAllChildren":165,"_process":168,"fbjs/lib/warning":37}],148:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":60,"./ReactCompositeComponent":71,"./ReactEmptyComponent":92,"./ReactNativeComponent":106,"_process":168,"fbjs/lib/invariant":26,"fbjs/lib/warning":37}],157:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":90,"_process":168,"fbjs/lib/invariant":26}],160:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./escapeTextContentForBrowser":145,"./setInnerHTML":162,"fbjs/lib/ExecutionEnvironment":12}],164:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactCurrentOwner":72,"./ReactElement":90,"./ReactInstanceHandles":99,"./getIteratorFn":153,"_process":168,"fbjs/lib/invariant":26,"fbjs/lib/warning":37}],166:[function(require,module,exports){
(function (process){
/**
 * Copyright 2015, Facebook, Inc.
 * All rights reserved.
...
},{"./Object.assign":60,"_process":168,"fbjs/lib/emptyFunction":18,"fbjs/lib/warning":37}],167:[function(require,module,exports){
'use strict';
